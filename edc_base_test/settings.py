"""
Django settings for edc_base_test project.
...
SECRET_KEY = 'vcyt@&p$q)m_ah)m2i9jncu99^lsv=n%1^-8cd37#x$as6^muy'
...
ROOT_URLCONF = 'edc_base_test.urls'
...
WSGI_APPLICATION = 'edc_base_test.wsgi.application'
